...
N 1090 -530 1180 -530 {lab=VDD}
N 1090 -550 1090 -530 {lab=VDD}
...
N 1500 -380 1500 -350 {lab=GND}
N 1090 -510 1090 -490 {lab=GND}
N 1140 -390 1180 -390 {lab=GND}
N 1140 -410 1140 -390 {lab=GND}
...
C {vdd.sym} 1010 -550 0 0 {name=l17 lab=VDD}
C {gnd.sym} 1070 -480 0 0 {name=l19 lab=GND}
C {lab_pin.sym} 1510 -440 0 1 {name=p9 sig_type=std_logic lab=out}
C {devices/capa.sym} 1500 -410 0 0 {name=C2
m=1
value=6p
footprint=1206
device="ceramic capacitor"}
C {gnd.sym} 1500 -350 0 0 {name=l16 lab=GND}
C {vdd.sym} 1090 -340 0 0 {name=l18 lab=VDD}
