...
N 270 -180 270 -140 {lab=#net1}
N 380 -180 380 -140 {lab=#net1}
N 520 -300 520 -260 {lab=#net2}
N 520 -400 520 -360 {lab=#net3}
N 520 -490 520 -460 {lab=#net4}
...
N 790 -180 820 -180 {lab=Vout}
N 130 -180 520 -180 {lab=#net1}
N 520 -180 670 -180 {lab=#net1}
